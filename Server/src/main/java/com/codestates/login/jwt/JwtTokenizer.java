...
public class JwtTokenizer {
    @Getter
    @Value("${jwt.key}") //Todo : 나중에 secretKey에 대한 보충 설정이 필요함
    ...
    public String generateRefreshToken(String subject,Date expiration,String base64EncodedSecretKey){//Refresh token 생성 메서드
        Key key = getKeyFromBase64EncodedKey(base64EncodedSecretKey);
